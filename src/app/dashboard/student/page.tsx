...
const recentResults = [
  { subject: 'Nepali', marks: 85, full: 100, grade: 'A', term: 'Mid Terminal' },
  { subject: 'English', marks: 92, full: 100, grade: 'A+', term: 'Mid Terminal' },
  { subject: 'C. Maths', marks: 95, full: 100, grade: 'A+', term: 'Mid Terminal' },
  { subject: 'Science', marks: 88, full: 100, grade: 'A+', term: 'Mid Terminal' },
  { subject: 'Social Studies', marks: 90, full: 100, grade: 'A+', term: 'Mid Terminal' },
  { subject: 'EPH', marks: 89, full: 100, grade: 'A+', term: 'Mid Terminal' },
];
    ...
    <DashboardLayout allowedRoles={['student']}>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            { label: 'Attendance', value: `${Math.round((attendance.present / attendance.total) * 100)}%`, icon: '📋', color: 'from-green-500 to-green-600', detail: `${attendance.present}/${attendance.total} days` },
            { label: 'Average Marks', value: `${avgMarks}%`, icon: '📊', color: 'from-blue-500 to-blue-600', detail: '6 subjects' },
            { label: 'Pending HW', value: '2', icon: '📝', color: 'from-orange-500 to-red-500', detail: 'Due this week' },
            { label: 'Class Rank', value: '5th', icon: '🏆', color: 'from-purple-500 to-purple-600', detail: 'out of 35' },
          ].map((stat, i) => (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="p-6">
                      ...
                      <div key={i} className="flex items-center gap-4 p-3 bg-gray-50 rounded-xl">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-2">
                            <div className="bg-green-500 h-2 rounded-full" style={{ width: `${(month.present / month.total) * 100}%` }}></div>
                          </div>
                        </div>
            ...
            {activeTab === 'results' && (
              <div>
                <h3 className="text-lg font-bold text-gray-800 mb-4">Mid Terminal Results - Class 10 A</h3>
                  ...
                  <table className="w-full">
                    ...
                    <tfoot className="bg-gray-50">
                      <tr>
                        ...
                        <td className="px-4 py-3"><span className="px-2 py-1 rounded-lg text-xs font-bold bg-green-100 text-green-700">A+</span></td>
                      </tr>
                    </tfoot>
                  </table>
                </div>
            ...
            {activeTab === 'homework' && (
              <div>
                <h3 className="text-lg font-bold text-gray-800 mb-4">Homework & Assignments</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  {homework.map((hw, i) => (
                    <div key={i} className={`p-4 rounded-xl border-2 ${
                      hw.status === 'Due Today' ? 'border-red-300 bg-red-50' :
                      hw.status === 'Pending' ? 'border-orange-200 bg-orange-50' :
