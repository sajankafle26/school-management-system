...
const parentTabContent: Record<string, React.ReactNode> = {
  overview: (
    <div className="space-y-4">
      <div className="grid lg:grid-cols-2 gap-4">
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
          <h3 className="font-bold text-gray-800 mb-4">Recent Results</h3>
  ...
  results: (
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
      <h3 className="font-bold text-gray-800 mb-4">Academic Results</h3>
        ...
        <div className="space-y-3">
          <div className="p-4 bg-green-50 rounded-lg border border-green-200">
            <div className="flex items-center justify-between">
              ...
              <span className="text-lg font-bold text-green-600">NPR 45,000</span>
            </div>
          </div>
          <div className="p-4 bg-red-50 rounded-lg border border-red-200">
            <div className="flex items-center justify-between">
              <span className="text-gray-700 font-medium">Pending Amount</span>
              <span className="text-lg font-bold text-red-600">NPR 15,000</span>
            </div>
          </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { label: 'Fee Pending', value: 'NPR 15,000', icon: '💰', bg: 'bg-orange' },
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100">
          {parentTabContent[activeTab] || parentTabContent.overview}
        </div>
      </div>
    </DashboardLayout>
  );
