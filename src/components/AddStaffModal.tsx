...
const AddStaffModal: React.FC<AddStaffModalProps> = ({ isOpen, onClose, onAddStaff }) => {
  ...
  const [profilePic, setProfilePic] = useState<string>('https://picsum.photos/seed/new-staff/100');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!name || !jobTitle || !contact || !email) {
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div className="md:col-span-2">
              ...
              <input type="text" id="jobTitle" value={jobTitle} placeholder="e.g., Accountant, Librarian" onChange={e => setJobTitle(e.target.value)} required className="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" />
            </div>
            <div>
